...
const aoc2025_day11_part1 = async (input: string, ...params: any[]) => {
...
const aoc2025_day11_part2 = async (input: string, ...params: any[]) => {
  const startTime = process.hrtime();
...
export default {
	year,
	day,
  part1: aoc2025_day11_part1,
  part2: aoc2025_day11_part2,
};